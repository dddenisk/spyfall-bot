...
LOCATIONS = [
   "Аэропорт", "Больница", "Школа", "Университет", "Кафе", "Ресторан", "Метро", "Пляж",
    "Космическая станция", "Военная база", "Тюрьма", "Кемпинг", "Офис", "Свадьба",
    "Пиратский корабль", "Подводная лодка", "Цирк", "Театр", "Кинотеатр", "Музей",
    "Зоопарк", "Церковь", "Супермаркет", "Банк", "Стадион", "Ферма", "Парк",
    "Пожарная станция", "Полиция", "Автобус", "Поезд", "Трамвай", "Спа-салон",
    "Казино", "Гостиница", "Кладбище", "Гараж", "Прачечная", "Суд", "Кабинет психолога",
    "Морской порт", "Горнолыжный курорт", "Секретная лаборатория", "Частный дом",
    "Башня", "Обсерватория", "Книжный магазин", "Планетарий", "Арт-галерея",
    "Тату-салон", "Бар", "Сексшоп", "Бункер", "Сауна", "Хирургия",
    "Барбершоп", "Аптека", "Бассейн", "Боулинг", "Вертолёт", "Деревня", "Дискотека",
    "ЖД-вокзал", "Караоке", "Компьютерный клуб", "Конюшня", "Кофейня",
    "Детский лагерь", "Лифт", "Маяк", "Аквапарк", "Кремль", "Библиотека", "Замок", "Детскийсад", "Завод",
    "Заправка", "Дрочильня", "Маршрутка"
]
